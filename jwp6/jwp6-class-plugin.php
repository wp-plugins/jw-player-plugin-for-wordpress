...
class JWP6_Plugin {
    ...
    public static $player_version = '6.9';

    public static $cdn_http_player = 'http://p.jwpcdn.com/6/9/jwplayer.js';

    public static $cdn_https_player = 'https://ssl.p.jwpcdn.com/6/9/jwplayer.js';
