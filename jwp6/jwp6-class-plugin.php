...
class JWP6_Plugin {
    ...
    public static $player_version = '6.10';

    public static $cdn_http_player = 'http://p.jwpcdn.com/6/10/jwplayer.js';

    public static $cdn_https_player = 'https://ssl.p.jwpcdn.com/6/10/jwplayer.js';
