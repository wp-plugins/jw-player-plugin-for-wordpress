...
class AdvancedState extends FlashVarState {
  ...
  protected function getFooter() { ?>
    <div class="stuffbox">
      <h3 class="hndle"><span><?php _e("Additional Flashvars"); ?></span></h3>
        ...
        <table class="form-table">
          <tr valign="top">
            ...
            <td>
              ...
              <br/>
              <span class="description"><?php _e("Enter one additional flashvar (name=value) per line that you would like to be used by this player.  <strong>Note:</strong> Overriding the standard flashvars could lead to unexpected behavior. "); ?></span>
            </td>
          </tr>
        </table>
      </div>
