              ...
              <?php foreach($plugins as $plugin) { ?>
                ...
                <tr valign="top">
                  ...
                  <td>
                    ...
                    <span class="description"><?php echo __($plugin->getDescription()) . "  <a href=" . $plugin->getPage() . JW_PLAYER_GA_VARS . " target=_blank>" . __("Learn more...") . "</a>"; ?></span>
                  </td>
                </tr>
                <tr>
                  <td colspan="2"></td>
              ...
              <table class="form-table">
                <tr valign="top">
                  ...
                  <td>
                    ...
                    <br/>
                    <span class="description"><?php _e("Enter a comma delimited list of additional plugins you would like to be used by this player.  <strong>Note:</strong> Flashvars for these plugins will need to be set in the Additional Flashvars section under the Advanced Settings tab."); ?></span>
                  </td>
                </tr>
              </table>
            </div>
